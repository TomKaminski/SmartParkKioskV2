          ...
          var tr = document.createElement('tr');
            for (var y = 0, lkey; lkey = lyt[y++];) {
              var td = document.createElement('td');
                ...
                if (lkey[0] == "0" || lkey[1] == "0") className.push("zeroNum");

              if (lkey[0] == "1" || lkey[1] == "1" || lkey[0] == "4" || lkey[1] == "4" || lkey[0] == "7" || lkey[1] == "7" || lkey[0] == "0" || lkey[1] == "0")
                className.push("numStart");

                if (lkey[0] == "Bksp" || lkey[1] == "bksp") className.push("bkspace");
              if (lkey[0] == "Wyczyść" || lkey[1] == "Clear") className.push("clear");
              if (lkey[0] == "Zamknij" || lkey[1] == "Close") className.push("close");
	...
	'layout': {
		'US International': {
			'name': 'US International', 'keys': [
				...
				[['a'], ['s'], ['d'], ['f'], ['g'], ['h'], ['j'], ['k'], ['l'], ['-'], ['4'], ['5'], ['6'],['Wyczyść','Clear']],
                [['@'], ['z'], ['x'], ['c'], ['v'], ['b'], ['n'], ['m'], ['.'], ['_'], ['1'], ['2'], ['3'],['Zamknij','Close']],
